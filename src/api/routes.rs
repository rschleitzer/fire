...
pub fn patient_routes(repo: SharedPatientRepo) -> Router {
    Router::new()
        ...
        .route("/fhir/Patient/:id", get(read_patient).post(update_patient_form).put(update_patient).delete(delete_patient))
...
pub fn observation_routes(repo: SharedObservationRepo) -> Router {
    Router::new()
        ...
        .route("/fhir/Observation/:id", get(read_observation).post(update_observation_form).put(update_observation).delete(delete_observation))
